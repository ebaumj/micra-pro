...
export const DialogContent = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DialogPrimitive.Portal mount={dialogContext.mount}>
      ...
      >
        {local.children}
        <DialogPrimitive.CloseButton class="absolute top-1 right-1 flex h-10 w-10 items-center justify-center rounded-xs opacity-70 transition-[opacity,box-shadow] active:opacity-100 disabled:pointer-events-none">
          <svg
