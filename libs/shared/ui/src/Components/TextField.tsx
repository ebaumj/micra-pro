...
export const TextField = <T extends ValidComponent = 'input'>(
  ...
  return (
    <TextFieldPrimitive.Input
      ...
      class={cn(
        'border-input placeholder:text-muted-foreground focus-visible:ring-ring flex h-9 w-full rounded-md border bg-transparent px-3 py-1 text-sm shadow-xs transition-shadow file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:ring-[1.5px] focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
        local.class,
      )}
      {...rest}
    />
