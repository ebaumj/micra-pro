  ...
  return (
    <AlertDialogPrimitive.Portal mount={dialogContext.mount}>
      ...
      <AlertDialogPrimitive.Content
        class={cn(
          'data-expanded:animate-in data-expanded:fade-in-0 data-expanded:zoom-in-95 data-expanded:slide-in-from-top-1/2 data-expanded:duration-200',
          'data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-closed:slide-out-to-top-1/2 data-closed:duration-200',
