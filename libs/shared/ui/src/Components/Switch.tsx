...
export const SwitchControl = <T extends ValidComponent = 'input'>(
  ...
  return (
    <>
      <SwitchPrimitive.Input class="outline-none" />
      <SwitchPrimitive.Control
        class={cn(
          'bg-input data-checked:bg-primary inline-flex h-5 w-9 shrink-0 items-center rounded-full border-2 border-transparent shadow-sm transition-[color,background-color,box-shadow] data-disabled:opacity-50',
          local.class,
        )}
        {...rest}
      >
