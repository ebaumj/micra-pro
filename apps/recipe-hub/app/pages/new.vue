<template>
  <div class="flex h-screen w-screen items-center justify-center bg-white">
    <svg
      v-if="loading"
      aria-hidden="true"
      class="inline h-20 w-20 animate-spin rounded-full fill-gray-600 p-4 text-gray-200 dark:fill-gray-300 dark:text-gray-600"
      viewBox="0 0 100 101"
      fill="none"
    ...
    <div
      v-if="!success && !loading"
      class="h-12 w-12 rounded-full bg-red-500"
    />
  </div>
</template>
